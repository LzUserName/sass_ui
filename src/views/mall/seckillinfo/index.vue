  ...
  <div class="execution">
    <basic-container>
      <avue-crud ref="crud"
        ...
        <template slot="seckillNumForm" slot-scope="scope" >
          <el-tooltip effect="dark" content="已售数量不能大于总限量!" placement="top">
            <el-input-number controls-position="right" v-model="form.seckillNum" :min="0" :max="form.limitNum" placeholder="请输入已售数量"></el-input-number>
          </el-tooltip>
        </template>
        <template slot="eachLimitNumForm" slot-scope="scope" >
          <el-tooltip effect="dark" content="每人限购数量不能大于总限量!" placement="top">
            <el-input-number controls-position="right" v-model="form.eachLimitNum" :min="1" :max="form.limitNum" placeholder="请输入每人限购数量"></el-input-number>
          </el-tooltip>
        </template>
        ...
        <template slot="picUrlForm"
          ...
          <MaterialList v-if="reFreshMaterialList" v-model="form.picUrl" type="image" :shopId="form.shopId"
