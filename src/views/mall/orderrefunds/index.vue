        ...
        <basic-container>
            <avue-crud ref="crud"
                ...
                <template slot-scope="scope" slot="status">
                    <el-tag type="warning" @click="handleOrderItemStatus(scope.row)"  style="cursor: pointer"><i class="el-icon-edit"></i>{{scope.row.statusDesc}}</el-tag>
                </template>
                ...
                <template slot-scope="scope" slot="orderId" v-if="scope.row.orderInfo">
                    <div style="text-align: left">
                        ...
                        <div class="grid-content">销售金额：<span class="jl-money-text">{{scope.row.orderInfo.salesPrice}}</span></div>
                        <div class="grid-content">运费金额：<span class="jl-money-text">{{scope.row.orderInfo.freightPrice}}</span></div>
                        <div class="grid-content">支付金额：<span class="jl-money-text">{{scope.row.orderInfo.paymentPrice}}</span></div>
                    ...
                    <el-form ref="orderRefunds" :model="orderRefunds" :rules="orderRefundsRules" label-width="80px">
                        ...
                        <el-form-item label="拒绝原因" prop="refuseRefundReson" v-if="orderRefunds.status == '12' || orderRefunds.status == '22' || orderRefunds.status == '212'">
                            <el-input type="textarea"  maxlength="200"
                                      show-word-limit v-model="orderRefunds.refuseRefundReson" placeholder="请填写拒绝原因"></el-input>
                        </el-form-item>
                        <el-form-item>
