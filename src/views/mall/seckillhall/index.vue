      ...
      <avue-crud ref="crud1"
        ...
        <template slot="listSeckillInfoForm" slot-scope="scope">
          <div>
            ...
            <el-row :gutter="4">
              <el-col :span="3" v-for="(item, index) in form.listSeckillInfo" :key="item.id">
                <el-card :body-style="{ padding: '0px' }" style="margin-top: 20px;">
                  ...
                  <div style="padding: 4px;">
                    ...
                    <div class="bottom clearfix">
                      <el-button type="text" class="button" size="mini" round @click="removeSeckillInfo(index)" style="color: red">
                        移除</el-button>
                    </div>
                  </div>
                </el-card>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      subGoods(){
        let selectionSeckillInfo = this.form.listSeckillInfo
        selectionSeckillInfo = [...selectionSeckillInfo, ...this.selectionSeckillInfo]
        //去重
        this.form.listSeckillInfo = unique(selectionSeckillInfo)
