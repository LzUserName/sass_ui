    ...
    <basic-container>
      <avue-crud :option="tableOption"
        ...
        <template slot="avatarForm"
                  slot-scope="scope">
          <div>
            <MaterialList v-model="form.avatar" type="image" :num=1 :shopId="form.shopId" :width=100 :height=100 v-if="form.shopId"></MaterialList>
            <div v-else class="jl-tips-class">先选择店铺后上传</div>
          </div>
        </template>
...
<script>
  ...
  import {tableOption} from '@/const/crud/upms/shopuser'
  ...
  export default {
    ...
    computed: {
      ...
      permissionList() {
        return {
          addBtn: this.permissions['mall:shopuser:add'] ? true : false,
          delBtn: this.permissions['mall:shopuser:del'] ? true : false,
          editBtn: this.permissions['mall:shopuser:edit'] ? true : false,
          viewBtn: this.permissions['mall:shopuser:get'] ? true : false
        }
      },
      permissionList2() {
        return {
