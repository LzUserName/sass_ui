...
<template>
  <div class="compSetting">
    <settingSlot @confirm="confirm" @cancel="cancel" @reset="reset" :showReset="true">
      <p slot="dialogTitle">首页顶部广告图设置</p>
      <div slot="hint">
        <div class="tips-class " >提示：建议图片高度为40px。</div>
      </div>
      <div slot="mainContent">
        <el-form ref="form"  label-width="90px" :model="formData">
          ...
          <el-form-item label="图片">
            <MaterialList :value="formData.imgUrl?[formData.imgUrl]:[]"  @sureSuccess="formData.imgUrl = $event?$event[0]:''"
                          @deleteMaterial="formData.imgUrl = ''" type="image" shopId="-1"
                          :num="1"  :height="70"></MaterialList>
          </el-form-item>
