            ...
            <div v-for="(item,index) in formData.shopInfoData" :key="index" style="margin-top: 8px;">
              <el-row>
                <el-col :span="3" style="text-align: center;padding-left: 5px;">
                  <div class="draggable-focus margin-top-xs "><i class=" el-icon-d-caret" ></i></div>
                  <div @click="delItem(index)" class="del-focus" ><i class="delIcon el-icon-delete" ></i></div>
                </el-col>
                <el-col :span="21">
                  <div  class="notDraggable solid ">
                    <el-row >
                      <el-col :span="6" >
                        <img :src="item.imgUrl" style="width: 70px;height: 70px;margin-left: 10px" >
                      </el-col>
                      <el-col :span="17" >
                        <el-form-item label="" label-width="0px" style="width: 100%;margin-top: 15px;">
