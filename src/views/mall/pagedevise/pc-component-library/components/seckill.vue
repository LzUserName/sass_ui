    ...
    <div class="wrapper-list"
      ...
      <div class="cu-bar"  style="margin-left: 10px;">
        <div class="shop-selection text-df  margin-top-sm margin-bottom flex align-center" >
          ...
          <img v-else class=" margin-right-xs" src="../assets/images/icon/ic_seckill_title.png" style="width: 110px; height: 21px;">
...
<!--      <div class=" shop-detfdail flex grid justify-start" style="padding-left: 5px;">-->

      <div  class="cu-list  grid  col-5" style="width: 1226px;margin: 0 -5px;padding: 0 10px;">
        <div class=" ">
          <div v-if="setData.backgroundImg" :style="{background: setData.backgroundImg?`url(${setData.backgroundImg}) round`:''}" class="marking-img-box ">
            <div class="flex align-center text-white justify-center" style="height: 100%;" >
              <div>
                <div class="text-xxl justify-center"  style="font-size: 30px;font-weight: bold;">
                  {{curHour}}<span class="text-sm margin-left-xs">场</span>
                </div>
                <div style="margin-top: 50%">
                  <div class="margin-top">
                    距离结束还有
                  </div>
                  <div class="margin-top text-black" style="margin-top: 20%;">
                    <span class="time-down">00</span>:<span class="time-down">10</span>:<span class="time-down">58</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div v-for="(item, index) in 4" :key="index"  class="  " >
          <div class="item  radius goods-card" >
            ...
            <div class="padding-bottom-sm padding-lr-sm" :style="{color: `${setData.titleColor}`}">
              <div class="text-lg margin-top overflow-1">商品名称</div>
              <div class="sm margin-top cu-tag line-orange ">限量 100</div>
              <div class="flex margin-top text-xl text-red justify-center">
                <span class="text-price">999</span>
              </div>
            </div>
          </div>
        </div>
