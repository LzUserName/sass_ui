                    ...
                    <el-row style="margin-top: 10px;">
                      <el-col :span="12" >
                        <MaterialList
                          ...
                          type="image" :shopId="shopId"   :num=1 :width="160" :height="80"></MaterialList>
                      </el-col>
                      <el-col :span="12">
                      ...
                      <el-col :span="24">
                        <div>
                          <div class="notDraggable" style="padding-top: 5px">
                            <app-page-select-shop :shop-id="shopId" :page="item.pageUrl" @change="item.pageUrl=$event"></app-page-select-shop>
                          </div>
                        </div>
                      </el-col>
                    </el-row>
