                ...
                <draggable v-model="formData.goodsItem1.goodsList" :options="{animation:500, filter:'.notDraggable', preventOnFilter: false}" >
                  <div v-for="(item,index) in formData.goodsItem1.goodsList" :key="index" style="margin-top: 8px;" >
                          ...
                          <el-row style="margin-top: 10px;" >
                            <el-col :span="5" >
                              <MaterialList
                                ...
                                type="image"  :shopId="shopId"  :num=1 :width="70" :height="90"></MaterialList>
                            </el-col>
                            <el-col :span="19" >
                    ...
                    <div class="notDraggable" style="padding: 0 0 5px 20px">
                      <app-page-select-shop :shopId="shopId" :isRefresh="true" :page="item.pageUrl"
                                            @change="item.pageUrl=$event"></app-page-select-shop>
                    </div>
                  </div>
                </draggable>
              </div>
...
export default {
  components: { draggable, settingSlot,iconSelect,MaterialList, AppPageSelectShop   },
  data() {
    return {
