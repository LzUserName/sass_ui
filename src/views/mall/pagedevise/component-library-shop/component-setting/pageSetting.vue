...
<!--                        <div slot="view"></div>-->
<!--                    </el-oss-upload>-->
                    <div class="avatar-uploader" :show-file-list="false" :on-success="floorPlanSuccess" :before-upload="uploadPicBefore">
                        <img v-if="pageSet.shareImg" :src="pageSet.shareImg" width="80" height="80" class="avatar">
                        <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                        <div slot="view"></div>
                    </div>
...
export default {
    ...
    computed: {
        pageSetData: {
            get(){
                return this.$store.state.divpageShop.pageSetData
            },
            set(newVal){
