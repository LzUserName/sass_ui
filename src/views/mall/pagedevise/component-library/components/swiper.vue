...
<!--        :style="{ backgroundColor: setData.background }"-->
        ...
        <div v-if="setData.swiperList.length>0"  style="background-color: #f7f7f7; border-radius: 10px 10px 0 0;"
          ...
          <img :src="setData.swiperList[0].imageUrl" fit="fill" style="width:98%;height: 100%; border-radius: 10px; margin-left: 4px; margin-top: 4px;"
