      ...
      <div slot="mainContent">
        <el-form ref="form"  label-width="90px" :model="formData">
          ...
          <el-form-item label="文字大小">
            <el-input v-model="formData.fontSize" size="mini" style="margin-top: 5px" placeholder="文字大小">
            </el-input>
          </el-form-item>
          ...
          <el-form-item label="文字高度">
            <el-input v-model="formData.height" size="mini" style="margin-top: 5px" placeholder="文字高度">
            </el-input>
          </el-form-item>
          <el-form-item label="跳转链接" >
          </el-form-item>
          <div style="padding: 0 0 5px 20px">
            <app-page-select-shop :shopId="shopId" :page="formData.pageUrl" @change="formData.pageUrl=$event"></app-page-select-shop>
          </div>
