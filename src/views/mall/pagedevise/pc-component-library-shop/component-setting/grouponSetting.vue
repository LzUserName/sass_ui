        ...
        <el-form ref="form"  label-width="90px" :model="formData">
          ...
          <el-form-item label="第一张图片" style="margin: 5px 0;">
            <MaterialList :value="formData.backgroundImg?[formData.backgroundImg]:[]"  @sureSuccess="formData.backgroundImg = $event?$event[0]:''" @deleteMaterial="formData.backgroundImg = ''"
                          type="image" :shopId="shopId" :divStyle="'width:100%;margin-bottom:0px;height:100px;line-height: 100px;'" :num=1 ></MaterialList>
          </el-form-item>
          <el-form-item label="图片跳转"  style="margin-top: -15px;">
          </el-form-item>
          <div style="padding: 0 0 5px 20px">
            <app-page-select :clientType="clientType"  :shopId="shopId" :page="formData.backgroundImgPageUrl" @change="formData.backgroundImgPageUrl=$event"></app-page-select>
          </div>
          ...
          <el-form-item label="商品">
            <div >
              <el-button class="addBtn" type="primary" icon="el-icon-circle-plus" plain size="mini" @click="showGoodsList">选择拼团商品</el-button>
            </div>
          </el-form-item>
          <div>
...
import AppPageSelect from '@/components/app-page-select/IndexShop.vue'
