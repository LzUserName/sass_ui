...
<template>
  <div>
    <settingSlot @confirm="confirm" @cancel="cancel" @reset="reset" :showReset="true">
      ...
      <div slot="hint">
        <div class="tips-class " >提示：秒杀组件会自动加载当前时间的秒杀商品。请确保已添加秒杀商品！</div>
      </div>
      <!-- <div slot="hint">
        提示：建议最少6个
      </div> -->
      <div slot="mainContent">
        <el-form ref="form"  label-width="90px" :model="formData">
          ...
          <div style="padding: 0 0 5px 20px">
            <app-page-select :shopId="shopId"  :isRefresh="true" :page="formData.backgroundImgPageUrl" @change="formData.backgroundImgPageUrl=$event"></app-page-select>
          </div>
