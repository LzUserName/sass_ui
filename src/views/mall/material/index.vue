...
<template>
  <basic-container>
    <div style="margin-bottom: 5px">
      <el-select v-model="shopId" placeholder="请选择店铺" @change="changeShopInfo">
        <el-option
    ...
    <el-container>
      <el-aside width="unset">
        ...
        <el-tabs style="height: 400px;" tab-position="left" v-model="materialgroupObjId" v-loading="materialgroupLoading"
                 @tab-click="tabClick">
