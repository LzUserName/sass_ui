      ...
      <el-row :span="24" :gutter="10">
        ...
        <el-col  :span="19">
          ...
          <avue-crud ref="crud"
            ...
            <template slot="coverImgUrlForm" slot-scope="{type}">
              <wxMaMedia :appId="appId" :disabled="type!='add'" :url="form.coverImgUrl" @change="form.coverImgUrl=$event"></wxMaMedia>
            </template>
            <template slot="urlForm" slot-scope="scope">
              <div >
<!--                <app-page-select :isGoodsPage="true" :page="form.url" @change="form.url=$event" ></app-page-select>-->
              <!--  商品ID 回传-->
                <app-page-select :isGoodsPage="true" :page="form.url" @change="changeGoodsUrl" @changeGoods="changeGoods"></app-page-select>
              </div>
            </template>
...
<script>
  ...
  export default {
    name: 'wxlive',
    components: { AppPageSelect,wxMaMedia  },
    data() {
      return {
        headers: {
