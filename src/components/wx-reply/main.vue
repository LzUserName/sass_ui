...
<!--          <el-button type="primary" v-if="permissions['wxmp:wxmaterial:add']">新建视频<i class="el-icon-upload el-icon&#45;&#45;right"></i></el-button>-->
    ...
    <el-tab-pane name="news">
      ...
      <el-row>
        ...
        <el-dialog title="选择图文" :visible.sync="dialogNewsVisible" width="90%" append-to-body>
          <WxMaterialSelect :appId="appId" :objData="objData" @selectMaterial="selectMaterial" :newsType="newsType"></WxMaterialSelect>
        </el-dialog>
      </el-row>
    </el-tab-pane>
    <el-tab-pane name="music">
      ...
      <el-upload
        action="/upms/file/upload?fileType=music&dir=wx/music/"
        :headers="headers"
        :multiple="true"
        :file-list="[]"
  ...
  export default {
    ...
    methods:{
      ...
      handleSuccess(response, file, fileList) {
        this.$set(this.objData,'repUrl',response.link)
      },
      handleSuccess2(response, file, fileList) {
        this.$set(this.objData,'repHqUrl',response.link)
      },
    }
  };
</script>
