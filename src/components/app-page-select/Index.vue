...
<template>
  <div>
    <div>
      <el-select  size="small" style="float:left;width: 32%!important;" :disabled="isGoodsPage" filterable v-model="form.page" placeholder="请选择跳转页面"  @change="onChangePage">
      ...
      <el-select v-if="!isArticleInfo" size="small" style="float:left;width: 32%!important;margin-left: 5px;" :disabled="shopDisabled" filterable v-model="form.shopId" placeholder="请选择店铺" @change="onChangeShop">
    ...
    methods:{
      initPage(){
        if(this.page){
          ...
          if(this.isGoodsPage){
            this.form.page = '/pages/goods/goods-detail/index?id='
