 ...
 * 判断当前页面是否是平台系统页面
 */
export const judgePlatformPage = () => {
  if(window.location.hash.indexOf("#/login") == -1 && window.location.hash.indexOf("#/platform/") == -1
    && window.location.hash.indexOf("#/info/index") == -1 && window.location.hash.indexOf("#/authredirect") == -1){
    return false
  }else{
    return true
  }
