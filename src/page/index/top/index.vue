  ...
  <div class="avue-top">
    <div class="top-bar__left">
      <div class="avue-breadcrumb"
           v-if="showCollapse">
        <i class="icon-navicon avue-breadcrumb_collapse" style="font-size: 22px!important"
    ...
    <div class="top-bar__right">
      <el-tooltip effect="dark"
        ...
        <div class="top-bar__item">
          <el-link type="success" style="font-size: 12px" href="http://www.joolun.com/" target="_blank">获取源码</el-link>
        </div>
      </el-tooltip>
      ...
      <el-tooltip v-if="showFullScren"
                  ...
                  placement="bottom">
        <div class="top-bar__item">
          <i style="font-size: 18px;!important;" :class="isFullScren?'el-icon-full-screen':'icon-quanping'"
      ...
      <el-dropdown>
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item>
            <router-link to="/info/index" class="el-icon-s-custom"> 个人信息</router-link>
          </el-dropdown-item>
          <el-dropdown-item>
            <div @click="showMenuTree" class="el-icon-discount"> 我的权限</div>
          </el-dropdown-item>
